...
const mailOptions = {
  ...
  try {
    ...
    res.status(500).json({ message: 'Došlo je do greške prilikom slanja e-maila korisniku.' });
  }
  ...
  try {
    ...
    res.json({ message: 'Podaci su primljeni i obrađeni na serveru. E-mail je poslat.' });
