...
export default function CheckIcon(props) {
  return (
  <svg version="1.1" id="Capa_13" xmlns="http://www.w3.org/2000/svg" width="229.153px" height="229.153px" viewBox="0 0 229.153 229.153" style={{enableBackground: "new 0 0 229.153 229.153"}} {...props} >
